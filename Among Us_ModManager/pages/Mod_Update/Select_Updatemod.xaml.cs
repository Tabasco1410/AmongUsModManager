...
using Among_Us_ModManager; // ModInfo, AmongUsInstallation, AmongUsModDetector, LogOutputを参照
...
namespace Among_Us_ModManager.Pages.Mod_Update
{
    public partial class Select_Updatemod : Page
    {
        ...
        public Select_Updatemod(List<AmongUsInstallation> amongUsInstallations)
        {
            ...
            {
                _httpClient.DefaultRequestHeaders.Add("User-Agent", "AmongUsModManager/1.0 (Contact: your-email@example.com)");
            }
        ...
        private async Task<string> GetLatestTagByRedirect(string gitHubUrl)
        {
            ...
            client.DefaultRequestHeaders.Add("User-Agent", "AmongUsModManager/1.0 (Contact: your-email@example.com)");
