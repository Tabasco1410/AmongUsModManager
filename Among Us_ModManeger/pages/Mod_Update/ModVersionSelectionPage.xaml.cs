...
using Among_Us_ModManeger; // ModInfo を参照
    ...
    public partial class ModVersionSelectionPage : Page, INotifyPropertyChanged
    {
        ...
        private async void ExecuteUpdate_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    client.DefaultRequestHeaders.Add("User-Agent", "AmongUsModManeger/1.0 (https://github.com/あなたのGitHubユーザー名)");
        ...
        private async Task<List<string>> FetchLatestDllNamesFromGitHubRelease(string gitHubUrl)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("AmongUsModManeger", "1.0"));
